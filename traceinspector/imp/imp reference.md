...
- WIP: `make_array(size int, default val) -> array[val_ty]`: Returns an array of length `size` with values set as `default`
- WIP: `len(arr array[var]) -> int`: Returns the length of the array
